function Rt = Refl_TR_ADE_Matched(t, L, n_matched, lx, ly, lz, mua)

% this function returns the total time-resolved reflectance R(t) from an anisotropic slab of thickness L [um].
